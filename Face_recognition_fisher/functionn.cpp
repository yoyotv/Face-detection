...
extern double all_image_matrix[number_of_dataset][figure_height*figure_width];             //Create a vector*vector to store all image
...
void functionn::calculate_St() {

	///////////////////////////////////////////////////////////////////////////////////////////////////
	//This part is to calculate A  in form vector.

	vector<double> a(figure_height*figure_width, 0);
	vector<vector<double>> St_matrix(figure_height*figure_width, a);


	ofstream file;                           		//This part is storing every face to double check the data is correct or not.
	file.open("For_matlab/St.txt", fstream::app);		    //This part is storing every face to double check the data is correct or not.

	//Calculate the A_matrix
	for (int i = 0; i < number_of_dataset; i++) {
		for (int j = 0; j < figure_height*figure_width; j++) {
			a[j] = all_image_matrix[i][j] - average_face[j];  //a
			if (a[j] < 0) { a[j] = 0; };
		}
	    ///////////////////////////////////////////////////////////////
...
void functionn::calculate_Sb() {

	///////////////////////////////////////////////////////////////////////////////////////////////////
	//This part is to calculate A  in form vector.

	vector<double> a(figure_height*figure_width, 0);
	vector<vector<double>> Sb_matrix(figure_height*figure_width, a);


	ofstream file;                           		//This part is storing every face to double check the data is correct or not.
	file.open("For_matlab/Sb.txt", fstream::app);		    //This part is storing every face to double check the data is correct or not.

																//Calculate the A_matrix
	for (int i = 0; i < number_of_face_class; i++) {
		for (int j = 0; j < figure_height*figure_width; j++) {
			a[j] = class_average_face[i][j] - average_face[j];  //a
			if (a[j] < 0) { a[j] = 0; };
		}
		///////////////////////////////////////////////////////////////
		//This part is storing every face to double check the data is correct or not.
...
void functionn::calculate_Sw() {

	///////////////////////////////////////////////////////////////////////////////////////////////////
	//This part is to calculate A  in form vector.

	vector<double> a(figure_height*figure_width, 0);
	vector<vector<double>> Sw_matrix(figure_height*figure_width, a);


	ofstream file;                           		//This part is storing every face to double check the data is correct or not.
	file.open("For_matlab/Sw.txt", fstream::app);		    //This part is storing every face to double check the data is correct or not.

															//Calculate the A_matrix
	for (int i = 0; i < number_of_face_class; i++) {
		for (int j = 0; j < figure_height*figure_width; j++) {
			//a[j] = image_matrix[i][j] - average_face[j];  //a
			a[j] = all_image_matrix[i][j] - class_average_face[(i)/10][j];  //a
			if (a[j] < 0) { a[j] = 0; };
		}
		///////////////////////////////////////////////////////////////
		//This part is storing every face to double check the data is correct or not.
